        ...
        <div class="col-md-10">
            ...
            <c:forEach items="${hotProductList}" var="hotProduct">
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    <a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${hotProduct.pid}&cid=${hotProduct.category.cid}">
                        <img src="${pageContext.request.contextPath}/${hotProduct.pimage}" width="130" height="130" style="display: inline-block;">
                    </a>
                    <p><a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${hotProduct.pid}&cid=${hotProduct.category.cid}" style='color:#666'>${hotProduct.pname}</a></p>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            ...
            <c:forEach items="${newProductList}" var="newProduct">
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    <a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${newProduct.pid}&cid=${hotProduct.category.cid}">
                        <img src="${pageContext.request.contextPath}/${newProduct.pimage}" width="130" height="130" style="display: inline-block;">
                    </a>
                    <p><a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${newProduct.pid}&cid=${hotProduct.category.cid}" style='color:#666'>${newProduct.pname}</a></p>
